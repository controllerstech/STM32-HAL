...
struct attribute s_coils_attributes[] = {
  {"level", "bool", NULL, offsetof(struct coils, level), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_array s_apihandler_coils = {{"coils", "array", false, 0, 0, 0UL}, s_coils_attributes, sizeof(struct coils), (bool (*)(void *, size_t)) glue_get_coils, (void (*)(void *, size_t)) glue_set_coils};

static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_coils
};
